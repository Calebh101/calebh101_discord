...
class RecursiveCaster {
  ...
  static T cast<T>(Object? input) {
    ...
    if (T == Map<String, List<String>>) return ((dynamic value) => Map<String, List<String>>.from(value.map((e, a) => MapEntry(e as String, (a as List).map((e) => e as String).toList()))))(input) as T;
  ...
  static Iterable<Type> getAll() => [List<String>, Map<String, String>, Map<String, String>, Map<String, List<String>>, Map<int, String>, Map<String, bool>];
}
