...
class Page extends Selection {
  ...
  Future<void> _onSelect(OnSelectDetails details) async {
    ...
    await details.message.edit(color != null ? MessageUpdateBuilder(content: null, embeds: [EmbedBuilder(description: content, color: color)]) : MessageUpdateBuilder(content: content, embeds: []));
